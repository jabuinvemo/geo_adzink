...
SET NOMBRE_POC='VOLVO_XC40-AON_ABR2026_1_SIN_DESCARTES';
...
--`mm-new-business-reporting.ADVERTISING.COORDENADAS_EMPLAZAMIENTOS_INTERES`
 ...
 `mm-new-business-reporting.ADVERTISING.COORDENADAS_EMPLAZAMIENTOS_INTERES_REPORTING`
  ...
  WHERE CAMPAIGN=NOMBRE_POC_UBICACIONES_REPORTING
...
---------------------------------------------------
--------------------------------------------------
SELECT CAMPAIGN,periodo,--id_ubicacion,direccion,
...
where brand_ds is not null and CAMPAIGN like '%ALDI%'
